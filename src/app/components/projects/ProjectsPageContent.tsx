...
export default function ProjectsPageContent() {
  ...
  return (
    <div className="min-h-screen pt-16 pb-16 bg-gradient-to-b from-blue-50/40 via-white to-gray-50/70 dark:from-gray-900 dark:via-blue-950/10 dark:to-gray-950 relative">
